...
LIBVIRT_VERSION=${LIBVIRT_VERSION:10.0.0-4.el9}
QEMU_VERSION=${QEMU_VERSION:8.2.0-11.el9}
SEABIOS_VERSION=${SEABIOS_VERSION:1.16.3-2.el9}
EDK2_VERSION=${EDK2_VERSION:20240214-2.el9}
LIBGUESTFS_VERSION=${LIBGUESTFS_VERSION:1.50.1-7.el9}
GUESTFSTOOLS_VERSION=${GUESTFSTOOLS_VERSION:1.50.1-7.el9}
PASST_VERSION=${PASST_VERSION:0^20231204.gb86afe3-1.el9}
